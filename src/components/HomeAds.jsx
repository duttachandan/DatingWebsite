...
const HomeAds = () => {
  return (
    <div className="flex flex-col-reverse lg:flex-row h-fit py-9 px-10">
      <div className="basis-1/2 flex flex-col justify-center items-center gap-3">
        ...
        <p className="text-center italic">
          It all starts with trust. Romancedelight provides us with a chance to
          discover our own selves. And, we are now Bringing the LOVE of your
          life to your fingertips. Join us! 100% Verified by team.
        </p>
        <div className="flex flex-col gap-9 justify-center items-center">
          ...
          <div className="flex flex-row justify-between items-center gap-3">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm text-[#ed147d] italic">
                ...
                It’s your first step to find your
                perfect partner. Sign up, write your summary.
              </p>
            </div>
          </div>
          <div className="flex flex-row justify-between items-center gap-3">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm text-[#ed147d] italic">
                Talk to your partner. Know more about them. Start dating. Share
                your true emotions! Connect and get to know your partner! Start
                dating!
              </p>
            </div>
          </div>
